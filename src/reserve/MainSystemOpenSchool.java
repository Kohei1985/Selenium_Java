        ...
        try {
            ...
            for (int i = 1; i <= 25; i++) { //<----エクセルの範囲指定はここ！！1~26までの数字
                ...
                for (String place : places) {
                    ...
                    jse.executeScript("window.scrollBy(0,500)", "");//500px下にスクロール
                    //更新の場合
                    WebElement updtElement = driver.findElement(By.id("ctl00_ContentPlaceHolder1_btnMenuUserEntry"));
                    ...
                    if (url.equals("this.style.background='url(images/menu02_red.jpg)'")) {
                        ...
                        WebElement updElm01 = driver.findElement(By.name("ctl00$ContentPlaceHolder1$btnMenuUserEntry"));
                        ...
                        updElm14.click();
                        WebElement updElm15 = driver.findElement(By.name("ctl00$ContentPlaceHolder1$chkHogoshaName"));
                        updElm15.click();
                        ...
                        updElm19.click();
                        WebElement updElm20 = driver.findElement(By.name("ctl00$ContentPlaceHolder1$chkGroupKanaName"));
                        updElm20.click();
                        WebElement updElm21 = driver.findElement(By.name("ctl00$ContentPlaceHolder1$chkGroupKind"));
                        updElm21.click();
                        WebElement updElm22 = driver.findElement(By.name("ctl00$ContentPlaceHolder1$chkGroupNinzu"));
                        updElm22.click();
                        WebElement updElm23 = driver.findElement(By.name("ctl00$ContentPlaceHolder1$btnFukuInp"));
                        updElm23.click();
                        //副代表者入力
                        WebElement updElm24 = driver.findElement(By.name("ctl00$ContentPlaceHolder1$chkFukuUserID"));
                        updElm24.click();
                        WebElement updElm25 = driver.findElement(By.name("ctl00$ContentPlaceHolder1$chkFukuName"));
                        updElm25.click();
                        WebElement updElm26 = driver.findElement(By.name("ctl00$ContentPlaceHolder1$chkFukuKanaName"));
                        updElm26.click();
                        WebElement updElm27 = driver.findElement(By.name("ctl00$ContentPlaceHolder1$chkFukuPostCode"));
                        updElm27.click();
                        WebElement updElm28 = driver.findElement(By.name("ctl00$ContentPlaceHolder1$chkFukuAddress"));
                        updElm28.click();
                        WebElement updElm29 = driver.findElement(By.name("ctl00$ContentPlaceHolder1$chkFukuBirthDay"));
                        updElm29.click();
                        jse.executeScript("window.scrollBy(0,0600)", "");//600px下にスクロール
                        WebElement updElm30 = driver.findElement(By.name("ctl00$ContentPlaceHolder1$chkFukuJitakuTel"));
                        updElm30.click();
                        WebElement updElm31 = driver.findElement(By.name("ctl00$ContentPlaceHolder1$chkFukuFax"));
                        updElm31.click();
                        WebElement updElm32 = driver.findElement(By.name("ctl00$ContentPlaceHolder1$chkFukuMobile"));
                        updElm32.click();
                    ...
                    for (String reserveDay : reserveDays) {
                        ...
                        System.out.println(
                                yoyaku01.getPlaceName() + "/" + reserveMonth + "月" + reserveDay + "日" + youbi + "をID"
                                        + id + "で予約しました。");
