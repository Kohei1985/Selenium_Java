...
public class MainSystemPublicHallAll {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Person person1 = new Person("雉子谷", "sheet1", "中島/1/2/3", "スポーツ交流/4/5/6", "none/none/none/none",
                "none/none/none/none");
        Person person2 = new Person("浩平", "sheet2", "中島/1/2/3", "スポーツ交流/4/5/6", "none/none/none/none",
                "none/none/none/none");
        Person person3 = new Person("タオ・庄司", "sheet3", "中島/1/2/3", "スポーツ交流/4/5/6", "none/none/none/none",
                "none/none/none/none");
        Person person4 = new Person("前田", "sheet4", "中島/1/2/3", "スポーツ交流/4/5/6", "none/none/none/none",
                "none/none/none/none");
        Person person5 = new Person("垣内", "sheet5", "中島/1/2/3", "スポーツ交流/4/5/6", "none/none/none/none",
                "none/none/none/none");
        Person person6 = new Person("垣内", "sheet6", "中島/1/2/3", "スポーツ交流/4/5/6", "none/none/none/none",
                "none/none/none/none");
        Person person7 = new Person("垣内", "sheet7", "中島/1/2/3", "スポーツ交流/4/5/6", "none/none/none/none",
                "none/none/none/none");
        Person person8 = new Person("垣内", "sheet8", "中島/1/2/3", "スポーツ交流/4/5/6", "none/none/none/none",
                "none/none/none/none");
        //      ************************************************************************************************************
        //      規定値変数・インスタンス
        //Line通知
        ...
        DateByPlaceMaster hall02 = new DateByPlaceMaster("", "", "", "", "");
        List<String> sheetNames = new ArrayList<String>();
        Collections.addAll(sheetNames, person1.getSheet_nm(), person2.getSheet_nm(), person3.getSheet_nm(),
                person4.getSheet_nm(), person5.getSheet_nm());//"sheet1", "sheet2", "sheet3",
        List<String> places = new ArrayList<>();
        Collections.addAll(places, "中島", "スポーツ交流");
        ...
        try {
            ...
            for (String sheetName : sheetNames) {
                ...
                if (sheetName == "sheet1" || sheetName.equals("sheet1")) {
                    ...
                    hall01.setReserveDate01(instracts01.get(1));
                    hall01.setReserveDate02(instracts01.get(2));
                    hall01.setReserveDate03(instracts01.get(3));
                    //         hall01.setReserveDate04(instracts01.get(4));
                    hall02.setReserveDate01(instracts02.get(1));
                    hall02.setReserveDate02(instracts02.get(2));
                    hall02.setReserveDate03(instracts02.get(3));
                    //        hall02.setReserveDate04(instracts02.get(4));

                } else if (sheetName == "sheet2" || sheetName.equals("sheet2")) {
                    ...
                    hall02.setReserveDate03(instracts02.get(3));
                    //        hall02.setReserveDate04(instracts02.get(4));
                } else if (sheetName == "sheet3" || sheetName.equals("sheet3")) {
                    ...
                    hall02.setReserveDate03(instracts02.get(3));
                    //        hall02.setReserveDate04(instracts02.get(4));;
                } else if (sheetName == "sheet4" || sheetName.equals("sheet4")) {
                    ...
                    hall02.setReserveDate03(instracts02.get(3));
                    //        hall02.setReserveDate04(instracts02.get(4));
                } else if (sheetName == "sheet5" || sheetName.equals("sheet5")) {
                    ...
                    hall02.setReserveDate03(instracts02.get(3));
                    //        hall02.setReserveDate04(instracts02.get(4));
                } else if (sheetName == "sheet6" || sheetName.equals("sheet6")) {
                    ...
                    hall02.setReserveDate03(instracts02.get(3));
                    //        hall02.setReserveDate04(instracts02.get(4));
                } else if (sheetName == "sheet7" || sheetName.equals("sheet7")) {
                    ...
                    hall02.setReserveDate03(instracts02.get(3));
                    //        hall02.setReserveDate04(instracts02.get(4));
                } else if (sheetName == "sheet8" || sheetName.equals("sheet8")) {
                ...
                for (int i = 1; i <= 25; i++) { //<----エクセルの範囲指定はここ！！1~26までの数字
                    ...
                    for (String place : places) {
                        ...
                        System.out.println("デバック３" + chk_places.get(0) + chk_places.get(1));
                        //List　"reserveDays"に施設ごとの予約する日を格納し、拡張for文でreserveDayを繰り返す処理
                        ...
                        for (String reserveDay : reserveDays) {
                            ...
                            System.out.println(reserveMonth + "月" + reserveDay + "日");
                            jse.executeScript("window.scrollBy(0,500)", "");//500px下にスクロール
                            Thread.sleep(0500);
                            //更新の場合
                            ...
                            Select dropdown01 = new Select(driver
                                    .findElement(By
                                            .name("ctl00$ContentPlaceHolder1$ShinseiKumiawaseInp1$drpPurposeBunrui")));
                            ...
                            WebElement element06 = driver
                                    .findElement(By
                                            .name("ctl00$ContentPlaceHolder1$ShinseiKumiawaseInp1$txtShisetsuMeisho"));
                            ...
                            for (int j = 0; j < times; j++) {//予約を"j"回繰り返す <---ここの数字を変更で繰り返し回数指定
                                ...
                                System.out
                                        .println(yoyaku01.getPlaceName() + "/" + yoyaku01.getReserveDate() + "をID:" + id
                                                + "で予約しました。");
                                //戻るボタン2回
